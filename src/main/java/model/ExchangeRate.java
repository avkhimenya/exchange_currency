...
public class ExchangeRate {
    ...
    // вот здесь вычисляется курс на основе валютной пары и даты
    ...
    private HashMap<Integer, Double> allExchangeRate() {
        ...
        /* вот здесь должен быть реализован алгоритм для всех кодов из Currency.getCodes()
         * который высчитывает всевозможные комбинации и записывает их в мапу одним числом
